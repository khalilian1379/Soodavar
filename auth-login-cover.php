      ...
      <g id="Icon" transform="translate(27.000000, 15.000000)">
        ...
        <form id="formAuthentication" method="POST" action="">
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="email" name="email-username" pattern="[a-zA-Z0-9]+" placeholder="ایمیل / نام کاربری را وارد کنید" required />
          </div>
          ...
          <button class="btn btn-primary d-grid w-100" type="submit" name="login" value="login">
            ورود
          </button>
        </form>
