      ...
      <ul class="menu-inner py-1">
        ...
        <li class="menu-item">
          ...
          <ul class="menu-sub">
            ...
            <li class="menu-item">
              <a href="auth-verify-email-cover.php" class="menu-link">
                <div> تایید ایمیل </div>
              </a>
            </li>

            <li class="menu-item">
              <a href="auth-forgot-password-cover.php" class="menu-link">
                <div> بازیابی رمز </div>
              </a>
            </li>

            <li class="menu-item">
              <a href="auth-two-steps-cover.php" class="menu-link">
