    ...
    document.addEventListener("DOMContentLoaded", function () {
        {
            const f = document.getElementById("calendar"),
                ...
                y = { Business: "primary", Holiday: "danger", Personal: "success", Family: "warning", ETC: "info" },
            ...
            T.length &&
                ...
                V && (e = V.flatpickr({ monthSelectorType: "static", inline: !0 }));
            ...
            let i = new Calendar(f, {
                ...
                dateClick: function (e) {
                    ...
                    p(), B.show(), S && (S.innerHTML = "افزودن رویداد"), (E.innerHTML = "افزودن"), E.classList.remove("btn-update-event"), E.classList.add("btn-add-event"), k.classList.add("d-none"), (q.value = e), (D.value = e);
                },
                eventClick: function (e) {
                    (e = e),
                        (a = e.event).url && (e.jsEvent.preventDefault(), window.open(a.url, "_blank")),
                        B.show(),
                        S && (S.innerHTML = "به روزرسانی رویداد"),
                        (E.innerHTML = "به روزرسانی"),
            ...
            i.render(),
                ...
                FormValidation.formValidation(u, {
                    fields: {
                        eventTitle: { validators: { notEmpty: { message: "لطفا عتوان رویداد را وارد کنید " } } },
                        eventStartDate: { validators: { notEmpty: { message: "لطفا تاریخ شروع رویداد را وارد کنید " } } },
                        eventEndDate: { validators: { notEmpty: { message: "لطفا تاریخ پایان رویداد را وارد کنید" } } },
                    },
                    plugins: {
                ...
                E.addEventListener("click", (e) => {
                    var t, n;
                    E.classList.contains("btn-add-event")
                        ? r &&
                          ((n = {
                              ...
                              endStr: D.value,
                              display: "block",
                              extendedProps: { location: A.value, guests: P.val(), calendar: T.val(), description: F.value },
                          }),
                ...
                L.addEventListener("click", (e) => {
                    S && (S.innerHTML = "افزودن رویداد"), (E.innerHTML = "افزودن"), E.classList.remove("btn-update-event"), E.classList.add("btn-add-event"), k.classList.add("d-none"), g.classList.remove("show"), h.classList.remove("show");
                }),
                C &&
